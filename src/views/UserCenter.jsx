...
import headPortrait from '../asset/icon/headPortrait.png';
import iconPublic from '../asset/icon/iconPublic.png';
import person from '../asset/icon/person.png';
import clock from '../asset/icon/punchClock.png';
import go from '../asset/icon/go.png';
            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    <div className={styles.item}>
                        <img className={styles.itemImg}src={iconPublic} alt=""/>
